...
local Window = Rayfield:CreateWindow({
    ...
    KeySettings = {
       ...
       Key = {"bladeballkey"} -- List of keys that will be accepted by the system, can be RAW file links (pastebin, github etc) or simple strings ("hello","painebladeball")
    }
 })
...
local Toggle = MiscTab:CreateToggle({
 ...
 local Button = InfoTab:CreateButton({
    Name = "https://discord.com/invite/7KfWKD8jCS",
    Callback = function()
        print("hi")
    end,
 })
